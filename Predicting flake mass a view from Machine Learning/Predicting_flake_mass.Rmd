...
First we are going to perform a k-fold cross validation. Although linear models are less prone to overfit it is still of good practice to perform validdations on test sets.  
